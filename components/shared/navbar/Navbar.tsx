      ...
      <div className="mx-auto flex h-[68px] max-w-7xl items-center justify-between gap-6 px-6">
        ...
        <div className="hidden lg:flex items-center gap-2 flex-shrink-0">
          ...
          <Link
            href="/auth/signup"
            id="btn-register"
            className="px-4 py-2 text-sm font-medium text-[#9090aa] border border-white/10 rounded-lg transition-colors hover:text-white hover:border-white/25 hover:bg-white/5"
          >
            Register
          </Link>
          <Link
            href="/auth/signup"
            id="btn-get-started"
            className="ml-1 px-5 py-2 text-sm font-semibold text-white rounded-lg bg-gradient-to-br from-[#7c6aff] to-[#ff6a9e] shadow-[0_0_20px_rgba(124,106,255,0.35)] transition-all duration-200 hover:shadow-[0_0_28px_rgba(124,106,255,0.55)] hover:-translate-y-0.5 active:translate-y-0"
          >
            Get Started
          </Link>
        </div>
      ...
      >
        ...
        <div className="flex flex-col gap-3 pt-4 border-t border-white/10">
          ...
          <Link
            ...
            className="w-full py-3 text-center text-sm font-semibold text-white rounded-lg bg-gradient-to-br from-[#7c6aff] to-[#ff6a9e] shadow-[0_0_15px_rgba(124,106,255,0.3)] transition-opacity hover:opacity-90"
            onClick={() => setMenuOpen(false)}
          >
            Get Started →
          </Link>
